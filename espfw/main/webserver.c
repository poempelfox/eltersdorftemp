...
/* These are in eltersdorftemp_main.c */
...
<html><head><title>ESP32-Foxtemp - Eltersdorf edition</title>
<style type="text/css">
...
<input type="text" name="updateurl" value="https://www.poempelfox.de/espfw/eltersdorftemp.bin">
</form>
...
esp_err_t get_publicdebug_handler(httpd_req_t * req) {
  ...
  pfp += sprintf(pfp, "base MAC: %02x%02x%02x%02x%02x%02x<br>",
